...
- Add the side-effect-free package-root public subagent tree API with nested settlement, fork-lineage reattachment, versioned callbacks, and fail-closed cancellation.
